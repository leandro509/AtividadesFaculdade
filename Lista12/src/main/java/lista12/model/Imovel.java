...
public class Imovel {
    ...
    public double calcularIptu() throws IllegalArgumentException  {
        ...
        setArea(area);
            ...
            System.out.println("Erro ao definir a area : " + e.getMessage());
        }
        
        try{
        setEndereco(endereco);
        }catch(IllegalArgumentException e){
            System.out.println("Erro ao definir o endereco : " + e.getMessage());
        }
        
        try{
        setFinalidade(finalidade);
        }catch(IllegalArgumentException e){
            System.out.println("Erro ao definir a finalidade : " + e.getMessage());
        }
        
        try{
        setBairro(bairro);
        }catch(IllegalArgumentException e){
            System.out.println("Erro ao definir o bairro : " + e.getMessage());
        }
