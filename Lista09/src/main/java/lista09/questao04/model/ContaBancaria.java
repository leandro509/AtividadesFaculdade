...
public class ContaBancaria {
    ...
    public void depositar(double valor) {
        Movimento movimentoDeposito = new Movimento(valor, TipoMovimento.CREDITO);
        incluirMovimento(movimentoDeposito);
        if(valor <= 0) {
    ...
    public void sacar(double valor) {
        Movimento movimentoSaque = new Movimento(valor, TipoMovimento.DEBITO);
        incluirMovimento(movimentoSaque);
